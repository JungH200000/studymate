...
학습 인증 화면에서는 목표와 요약, 학습 시간, 학습 자료까지 입력하는 JSON 인증글을 하루 한 번 업로드 할 수 있습니다. 서버가 챌린지별 하루 1회 제한을 검증해 공정성을 지키고 인증글 목록에서는 주간 진행 횟수와 응원 토글, 응원자 목록이 실시간으로 갱신되어 동료들과 학습 성과를 공유할 수 있습니다.
